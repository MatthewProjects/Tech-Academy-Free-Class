...
async function registerSwingCommands(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand(`${constants_1.EXTENSION_NAME}.run`, async () => {
        var _a;
        (_a = store_1.store.activeSwing) === null || _a === void 0 ? void 0 : _a.webView.rebuildWebview();
    }));
    ...
    context.subscriptions.push(vscode.commands.registerCommand(`${constants_1.EXTENSION_NAME}.openSwingInNewWindow`, async () => {
        const folder = await vscode.window.showOpenDialog({
            canSelectFolders: true,
            canSelectFiles: false,
            canSelectMany: false,
